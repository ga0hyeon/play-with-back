...
(member_auth_id, login_id, nick_name, auth_type, profile_url, email_addr, age, gender, expire_date, creation_date, created_by, last_update_date, last_updated_by)
VALUES('tlsxotlr', 'tlsxotlr', '그로밋', 'NAVER', '', 'tlsxotlr@navar.com', 0, 'M', null, now(), 0, now(), 0);
